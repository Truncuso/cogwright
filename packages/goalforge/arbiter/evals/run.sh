...
SDD_HARDEN_MD="$(cd "$SKILL_DIR/../harden" && pwd)/SKILL.md"
PASS=0
FAIL=0
...
# Wiring: harden references goalforge-arbiter
check "harden wires goalforge-arbiter" "goalforge-arbiter" "$SDD_HARDEN_MD"
