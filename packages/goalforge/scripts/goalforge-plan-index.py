#!/usr/bin/env python3
"""sdd-plan-index.py -- derive plans/INDEX.md from feature-overview frontmatter.
...
Usage:
  sdd-plan-index.py [--plans-root <root>] [--include-archived] [-o <file>]
...
def render(root: Path, feats: dict, edges: list, tier_list: list, cycle: list) -> str:
    ...
    L.append("")
    L.append("- **Status:** reference (generated by `sdd-plan-index.py`)")
