...
`${CLAUDE_PLUGIN_ROOT}/references/dispatch-template.md` and are **not duplicated
...
2. **parallel spec authors** — two spec-author subagents fire concurrently.
   ...
   the one in `${CLAUDE_PLUGIN_ROOT}/references/dispatch-template.md` (referenced by
